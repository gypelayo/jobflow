...
- **Bundle licensing** — license key infrastructure for the Job Search Bundle ([#41](https://github.com/gypelayo/job-tool/issues/41)) ✅
- **CV generation gate** — CV generation gated behind active bundle ([#42](https://github.com/gypelayo/job-tool/issues/42)) ✅
- **Paywall UI** — inline locked-state component for gated features ([#43](https://github.com/gypelayo/job-tool/issues/43)) ✅

## Backlog

- **Insights engine** — surface patterns from the user's own data: response rate by company size, skill correlation, seniority mismatch warnings ([#35](https://github.com/gypelayo/job-tool/issues/35))
- **Multiple profiles** — separate pipelines and analytics per search strategy
- **Hosted AI** — no API key required for extractions, bundle-only ([#44](https://github.com/gypelayo/job-tool/issues/44))
